...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="form-control card mt-3 mb-3">
        ...
        <div class="card-body">
            ...
            <div class="d-flex">
                <asp:TextBox ID="txtStartDate" type="search" TextMode="Date" runat="server" CssClass="form-control" Width="320px"></asp:TextBox>
                <asp:TextBox ID="txtEndDate" type="search" TextMode="Date" runat="server" CssClass="form-control ms-5" Width="320px"></asp:TextBox>
            </div>
            <div class="d-flex">
                <div>

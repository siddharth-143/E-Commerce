...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container">
        ...
        <div class="form-control card mt-3">
            ...
            <div class="card-body">
                <p>Brand Name</p>
                <asp:TextBox ID="txtBrandName" runat="server" CssClass="form-control" Width="320px"></asp:TextBox>
                ...
                <div>
                    ...
                    <asp:Button ID="btnClear" runat="server" CssClass="btn btn-warning" Text="Clears" OnClick="btnClear_Click" />    <asp:Label ID="lblMsg" runat="server" Text="" ForeColor="Red"></asp:Label>
                </div>
            </div>
        </div>
        <br />
